                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="site_title" value="<?php print $site_title ?>">
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label"> Site
                                                        Keywords</label>
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="site_keyword" value="<?php print $site_keyword ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="site_desc" rows="3"
                                                        placeholder="Enter Site Description"><?php print $site_desc ?></textarea>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="site_about" rows="3"
                                                        placeholder="Enter Footer About Text"> <?php print $site_about ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="site_footer" placeholder="&copy; 2024 Expo Computer"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label for="firstnameInput" class="form-label">Social Follow
                                                        Text</label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea5"
                                                        name="follow_text" rows="3"
                                                        placeholder="Enter Footer follow us session Text"><?php print $follow_text ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="firstnameInput"
                                                        name="site_url" placeholder="https://website.com"
                                                        value="<?php print $site_url ?>">
                                                </div>
                                            </div>
